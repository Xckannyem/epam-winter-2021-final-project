...
class Employee(UserMixin, db.Model):
    ...
    first_name = db.Column(db.String(length=60), index=True, nullable=False, unique=True)
    last_name = db.Column(db.String(length=60), index=True, nullable=False, unique=True)
